#This is PreMade Module file DO NOT RUN
#Keep Handvolume2.0.py file in the same directory 
...
class handDetector():
    ...
    def findDistance(self, p1, p2, img, draw=True):
        ...
        if draw:
            ...
            cv2.circle(img, (cx, cy), 10, (100, 30, 255), cv2.FILLED)
...
def main():
    ...
    detector = handDetector(detectionCon=0.7, maxHands=1)  # Specify detection confidence here
